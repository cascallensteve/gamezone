...
# For environment variables - use os.environ.get() instead of decouple for now
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-8d^)*l9hw+d#%n(_u#3!8+09^e=**9xog9lbve2$p+lra1k)3@')
